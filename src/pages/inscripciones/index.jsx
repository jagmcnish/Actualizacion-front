  ...
  return (
    <PrivateRoute roleList={['ADMINISTRADOR', 'LIDER']}>
      <div className='p-10'>
        ...
        <div className=' text-2xl font-bold text-gray-900 '>Caracteristicas inscripciones</div>
        </div>
        <div className='my-4 uppercase font-bold text-green-400' >
...
const Inscripcion = ({ inscripcion, refetch }) => {
  ...
  return (
    <div className='bg-green-500 text-gray-50 flex flex-col p-6 m-2 rounded-lg shadow-xl'>
